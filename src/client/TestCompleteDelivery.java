...
public class TestCompleteDelivery {
    ...
    public TestCompleteDelivery() {
        ...
        OrderDelivery od = new OrderDelivery(1, "20:00", "13/12/2017", "Dilraba", "", 0, 0, 0, "Tony", "MCD", 0, "Pending");
        odList.add(od);
        od = new OrderDelivery(2, "20:00", "13/12/2017", "Yunni", "", 0, 0, 0, "Alex", "MCD", 0, "Pending");
        odList.add(od);
        od = new OrderDelivery(3, "20:00", "13/12/2017", "Yunni", "", 0, 0, 0, "Alex", "MCD", 0, "Pending");
        odList.add(od);
