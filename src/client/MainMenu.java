...
public class MainMenu {
    ...
    public static void initItem() {
        ...
        iList.add(itf);
        itf = new Item("Nasi Lemak with Egg", 5.00, "Melawati Nasi Lemak");
        iList.add(itf);
        itf = new Item("Nasi Lemak with Fried Chicken", 8.00, "Melawati Nasi Lemak");
        iList.add(itf);
        itf = new Item("Nasi Lemak with Currry Chicken", 9.00, "Melawati Nasi Lemak");
        iList.add(itf);
        itf = new Item("Bentong Cincau", 3.00, "Melawati Nasi Lemak");
        iList.add(itf);
