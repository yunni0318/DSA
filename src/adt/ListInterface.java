 ...
 * * positions that begin with 1. * * @author Frank M. Carrano * @version 2.0
 */
public interface ListInterface<T> {
     ...
     * position within the list. The list's size is increased by 1. * * @param
     * newPosition an integer that specifies the desired position of the * new
     * entry * @param newEntry the object to be added as a new entry * @return
     * true if the addition is successful, or false if either the list is *
    ...
    /**
     * * Task: Replaces the entry at a given position in the list. * * @param
     * givenPosition an integer that indicates the position of the entry to * be
     * replaced * @param newEntry the object that will replace the entry at the
     * position * givenPosition * @return true if the replacement occurs, or
     * false if either the list is * empty, givenPosition < 1, or givenPosition
     * > getLength()
     */
    ...
    /**
     * * Task: Sees whether the list contains a given entry. * * @param anEntry
     * the object that is the desired entry * @return true if the list contains
     * anEntry, or false if not
     */
